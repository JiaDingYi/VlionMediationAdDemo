//
//  VLIONDrawViewController.m
//  VlionMediationAd_Example
//
//  Created by jdy_office on 2025/6/19.
//  Copyright © 2025 jdy. All rights reserved.
//

#import "VLIONDrawViewController.h"
#import <VlionMediationAd/VlionMediationNativeAd.h>
#import <SDWebImage/SDWebImage.h>

@interface VLIONDrawViewController () <VlionNativeAdsManagerDelegate, VlionMNativeAdDelegate, VlionNativeExpressAdViewDelegate>
...
@implementation VLIONDrawViewController
...
- (void)showAd {
    if (self.nativeAd.isExpressAd) {
        ...
        if ([self isVideoWith:self.nativeAd]) {
            ...
            self.nativeView.mediaView.frame = CGRectMake(margin, y, contentWidth, videoHeight);
